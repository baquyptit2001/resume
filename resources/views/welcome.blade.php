...
<!-- Mirrored from retrina.com/demo/arshia/cv/dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jul 2021 11:57:52 GMT -->
<head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <title>Nguyễn Bá Quý - D19PTIT</title>
                        ...
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div class="hero-content">
                                ...
                                <ul class="list-inline hero-social">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="https://github.com/baquyptit2001"target="_blank">
                                            <img src="assets/img/github.svg" alt="">
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="https://www.linkedin.com/in/nguy%E1%BB%85n-b%C3%A1-qu%C3%BD-513672213/"target="_blank">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2">
                            <div class="hero-images">
                                ...
                                <div class="rounded-circle">
                                    <img src="assets/img/baquy.jpg" alt="/" class="rounded-circle img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text-center title">
                                    ...
                                    <p class="text-muted max-width-450 mb-5"> First, solve the problem.Then write the code. <br> - John Johnson -</p>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="image-border">
                                    <img src="assets/img/baquy.jpg" alt="/">
                                </div>
                            </div>
                            <div class="col-lg-6 mt-4 mt-lg-0">
                                <div class="personal-item ">
                                    <h3 class="text-dark mt-4 mt-lg-0"><span class="base-color">GenZ</span> Student & Web Developer</h3>
                                    <div class="row">
                                        <div class="col-6 personal-info">
                                            <ul class="list-unstyled pt-4">
                                                ...
                                                <li>
                                                    <p>City : <span> Thanh Xuân, Hà Nội</span></p>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-6 personal-info">
                                            <ul class="list-unstyled pt-4">
                                                ...
                                                <li>
                                                    <p>Mail : <span> <a href="mailto:quynb201@gmail.com" style="color: #d2d2d2">quynb201@gmail.com</a></span></p>
                                                </li>
                                                <li>
                                ...
                                <div class="button-border mt-3 mb-lg-0 mr-4">
                                    <a href="https://drive.google.com/file/d/18hFLRiFIJo6NL2lQ0zwwYHdlNRa0TrDU/view" target="_blank" class="pill-button">Download Cv</a>
                                </div>
                                ...
                                <div class="col-lg-4 text-left">
                                    <div class="services-item box-hover-border">
                                        <div class="float-left mt-lg-1 d-inline-block services-icon">
                                            <i class="lni-pencil size-md base-color"></i>
                                        </div>
                                        <div class="services-content">
                                            <h5 class="mb-3">Study</h5>
                                            <p class="text-muted mb-0">Yeah, I'm a student and I'm looking for a part-time job</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Item 02 -->
                                <div class="col-lg-4 text-left">
                                    <div class="services-item box-hover-border">
                                        ...
                                        <div class="services-content">
                                            ...
                                            <p class="text-muted mb-0">PHP/Laravel, VueJS, Bootsrap, HTML/CSS, JavaScript</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Item 03 -->
                                <div class="col-lg-4 text-left">
                                    <div class="services-item box-hover-border">
                                        ...
                                        <div class="services-content">
                                            ...
                                            <p class="text-muted mb-0">Can handle photos and design banners at a basic level </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="display-content">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text-center title">
                                    ...
                                    <p class="text-muted max-width-450 mb-5">The computer was born to solve problems that did not exist before. - Bill Gates</p>
                                </div>
                            </div>
                        </div>
                        <!--    TimeLine Start   -->
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="timeline-items box-border">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-contents">
                                            <div class="time-line-header">
                                                <h6 class="timeline-title">Studying at Posts and Telecommunications Institute of Technology</h6>
                                                <p class="timeline-year">2019 - 2024 (expected)</p>
                                            </div>
                                            <div class="timeline-content">
                                                <p>Studying for a Bachelor of Information Technology</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--    Item 02   -->
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-contents">
                                            <div class="time-line-header">
                                                <h6 class="timeline-title">Studied at Bach Khoa - Aptech</h6>
                                                <p class="timeline-year">2020 - 2021</p>
                                            </div>
                                            <div class="timeline-content">
                                                <p>Short-term Fullstack PHP Course</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 mt-5 mt-lg-0">
                                ...
                                <div class="timeline-items box-border">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-contents">
                                            <div class="time-line-header">
                                                <h6 class="timeline-title">Personal Project</h6>
                                                <p class="timeline-year">2021</p>
                                            </div>
                                            <div class="timeline-content">
                                                <p>Basic E-Commerce website using Laravel <br><a href="http://baquyptit2001.herokuapp.com/" target="_blank" rel="noopener noreferrer" style="color: #d31d4d">Demo</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-5 justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <h3 class="mb-0 mt-5 mt-lg-0">Work <span class="base-color"> Skills</span></h3>
                                </div>
                                <div class="language-bar box-border">
                                    <div class="language-skill row">
                                        <h4 class="col-6 text-left mb-0">PHP/Laravel</h4>
                                        <h4 class="col-6 text-right mb-0">VueJS</h4>
                                    </div>
                                    <div class="language-skill row">
                                        <h4 class="col-6 text-left mb-0">HTML, CSS</h4>
                                        <h4 class="col-6 text-right mb-0">JavaScript, Jquery</h4>
                                    </div>
                                    <div class="language-skill row">
                                        <h4 class="col-6 text-left mb-0">C/C++</h4>
                                        <h4 class="col-6 text-right mb-0">Python</h4>
                                    </div>
                                    <div class="language-skill row">
                                        <h4 class="col-12 text-center mb-0">Adobe Photoshop</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4 mt-5">
                                <div class="text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <small class="text-muted">Thanh Xuân, Hà Nội</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 mt-5">
...
<!-- Mirrored from retrina.com/demo/arshia/cv/dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jul 2021 11:58:04 GMT -->
</html>